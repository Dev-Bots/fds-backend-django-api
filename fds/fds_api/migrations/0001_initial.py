# Generated by Django 4.0.3 on 2022-05-27 12:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, upload_to='images/profile_pictures/', verbose_name='Profile picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_default', models.BooleanField(default=False, verbose_name='Default skills')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('formation', models.CharField(max_length=255, verbose_name='Formation')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='teams', to='fds_api.event')),
            ],
        ),
        migrations.CreateModel(
            name='PlayerMore',
            fields=[
                ...
                ('video', models.FileField(blank=True, upload_to='video/', verbose_name='Video link')),
                ('birth_certificate', models.FileField(upload_to='images/birth_certifcate/', verbose_name='Birth certificate')),
                ('education_level', models.CharField(max_length=255, verbose_name='Education level')),
                ('highest_education_evidence', models.FileField(upload_to='images/education/', verbose_name='Education evidence')),
                ...
                ('playing_possition1', models.CharField(choices=[('GK', 'Gk'), ('DEF', 'Def'), ('MID', 'Mid'), ('STR', 'Str')], max_length=50, verbose_name='Playing possition 1')),
                ('playing_possition2', models.CharField(choices=[('GK', 'Gk'), ('DEF', 'Def'), ('MID', 'Mid'), ('STR', 'Str')], max_length=50, verbose_name='Playing possition 2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='matches', to='fds_api.event')),
                ('team1', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='team1', to='fds_api.team')),
                ('team2', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='team2', to='fds_api.team')),
            ],
        ),
        migrations.CreateModel(
            name='ClubMore',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.TextField(verbose_name='Choice')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choices', to='fds_api.question', verbose_name='Question')),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('player_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='Player')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fds_api.question', verbose_name='Question')),
            ],
        ),
        migrations.CreateModel(
            name='Club',
        ...
        migrations.AddField(
            model_name='team',
            name='players',
            field=models.ManyToManyField(blank=True, to='fds_api.player'),
        ),
        migrations.AddField(
            model_name='skill',
            name='club',
        ...
        migrations.AddField(
            model_name='event',
            name='club',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='fds_api.club'),
        ),
        migrations.AddField(
            model_name='event',
            name='scouts',
            field=models.ManyToManyField(blank=True, related_name='assigned_eventd', to='fds_api.scout'),
        ),
    ]
